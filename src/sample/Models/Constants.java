...
public class Constants {
    ...
    public static final String WELCOME_MESSAGE = "WELCOME TO THE TOY-WORLD WHOLE-SALE ENGINE SERVICE \n Thank you for choosing to work with Toy-World";

    public static final int A = 1001;
    public static final String MESSAGE_A = "Server: Send the toy name and identification code (e.g. HotWheels HW001)";
